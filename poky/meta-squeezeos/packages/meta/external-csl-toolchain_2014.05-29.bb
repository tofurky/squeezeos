...
do_unpack2() {
	mkdir -p ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2014.05/arm-none-linux-gnueabi ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2014.05/bin ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2014.05/lib ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2014.05/libexec ${CROSS_DIR}
	cp -r ${WORKDIR}/arm-2014.05/share ${CROSS_DIR}
}
